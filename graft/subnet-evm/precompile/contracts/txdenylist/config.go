...
// TxDenyList specific precompile config.
type Config struct {
...
// TxDenyList with the given [admins], [enableds] and [managers] as members of the deny list.
// Note: in the deny list context, "enabled" addresses are the ones being denied/blocked.
